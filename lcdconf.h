...
// if you chose the LCD_PORT_INTERFACE:
		...
		#define LCD_CTRL_PORT	PORTC_OUT
		#define LCD_CTRL_DDR	PORTC_DIR
		...
		#define LCD_DATA_POUT	PORTD_OUT
		#define LCD_DATA_PIN	PORTD_IN
		#define LCD_DATA_DDR	PORTD_DIR
...
#define LCD_LINES				3	// visible lines
#define LCD_LINE_LENGTH			16	// line length (in characters)
// cursor position to DDRAM mapping
#define LCD_LINE0_DDRAMADDR		0x00
#define LCD_LINE1_DDRAMADDR		0x10
#define LCD_LINE2_DDRAMADDR		0x20
